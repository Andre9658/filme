            ...
            <div className="w-full h-full py-[40px] px-[70px] flex flex-col">
                ...
                <div className="w-full flex justify-center pt-[40px]">
                    ...
                    className="w-full flex flex-col">
                        ...
                        <textarea value={sinopse}
                        className="w-full h-[150px] rounded-lg border focus:border-pink-400 p-2 bg-[#141414] outline-none"></textarea>
                    </div>
                    <CustomInput
                    onChange={
                    ...
                    <div className="w-full flex justify-end gap-4">
                        <button type="reset" className="w-[100px] h-[50px] rounded-md bg-[#141414] border-[#3a364c] cursor-pointer hover:bg-white/10">Cancelar</button>
